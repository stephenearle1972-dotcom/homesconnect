...
const STATIC_ROUTES = [
  ...
  { loc: '/calculators/bond-repayment', changefreq: 'monthly', priority: '0.6' },
  { loc: '/calculators/affordability', changefreq: 'monthly', priority: '0.6' },
  { loc: '/calculators/cost-of-buying', changefreq: 'monthly', priority: '0.6' },
